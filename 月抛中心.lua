...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『月抛中心』"; Text ="加载中"; Duration = 4; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『月抛中心』"; Text ="加载成功"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/kukunb/ui/refs/heads/main/Protected_2853209633855269.txt"))();        
local win = ui:new("月抛中心")
--
...
about:Label("月抛中心")
about:Label("作者QQ：3417181070")
about:Label("作者：kuku")
about:Label("本脚本永久免费")
about:Label("如果你购买了此脚本")
about:Label("恭喜你被圈了")
about:Label("欢迎使用月抛中心")
